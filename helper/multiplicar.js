...
const crearArchivo = async (j = 5, listar = true, hasta=20) => {
  try {
    let salida = "";
    let consola = "";
    for (i = 1; i <= hasta; i++) {
...
const crearArchivo = (j = 5) => {
  const promesa = new Promise((resolve, reject) => {
    ...
    console.log(salida); //el file system para grabar un archivo. usando WriteFileSync //como se ejecuta de manera asincrona ya no va el error. //Para controlar el error se usa try - catch.
    fs.writeFileSync(`tabla-del-${j}.txt`, salida);
